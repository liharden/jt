...
public class DistributedLimit {
    ...
    public Boolean distributedLimit(String key, String limit, String seconds) {
        ...
        try {
            id = redisTemplate.execute(limitScript, Collections.singletonList(key), limit, seconds);
            log.info("id:{}", id);
        } catch (Exception e) {
            log.error("error", e);
        }
    ...
    public Boolean distributedRateLimit(String key, String limit, String seconds) {
        ...
        log.info("调用redis执行lua脚本, {} {} {} {} {}", "ratelimit", intervalPerPermit, refillTime, limit, intervalInMills);
        try {
