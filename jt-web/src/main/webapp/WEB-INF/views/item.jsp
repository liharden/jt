	...
	<dl class="slogens">
	 ...
	 <div class="seller hide">
			...
			<ul id="choose" clstag="shangpin|keycount|product|choose">
				...
				<li id="choose-btns">
				<span id="time"></span>
					<div id="choose-btn-append" value="123" class="btn">
							<input class="btn-append " id="InitCartUrl" disabled="true" onclick="addCart()" type="button" value="加入购物车"><b></b></input>
						<div style="color: red" >${fall}<div/>
					</div>
				 ...
				 <span id="time"></span> 
				  <input id="itemId" value="${item.id}" type="button" disabled="true" style="display: none"/>
      <input type="button" value="开始抢购" id="buy" disabled="true" onclick="addCart2()">
     <script>
         ...
         function Time() {
             ...
             document.getElementById("time").innerHTML = "距离抢购开始还有：" + showhour + ":" + showmin + ":" + showsec;
       ...
       function addCart2(){
         ...
         ajax.open('get','http://www.jt.com/placeOrder/'+itemId);
         //步骤三:发送请求
         ajax.send();
         //步骤四:注册事件 onreadystatechange 状态改变就会调用
         ajax.onreadystatechange = function () {
        	 //alert(ajax.responseText);
            if (ajax.responseText==itemId) {
             //步骤五 如果能够进到这个判断 说明 数据 完美的回来了,并且请求的页面是存在的
           　　　　//alert(ajax.responseText);//输入相应的内容
           document.getElementById("buy").style.display="none";
           document.getElementById("InitCartUrl").disabled="";
             　　}}
       }
     </script>
			</ul><!--choose end-->
