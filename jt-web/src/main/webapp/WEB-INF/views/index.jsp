...
<meta name="description"
	...
	<meta name="Keywords"
		content="网上购物,网上商城,手机,笔记本,电脑,MP3,CD,VCD,DV,相机,数码,配件,手表,存储卡,京淘商城">
	...
	<div class="w">
		<div id="o-slide">
			<div class="slide" id="slide">
				<img
					src="https://m.360buyimg.com/babel/jfs/t1/27017/6/15311/91326/5cb08608E9a2ae675/05795326c8a57bed.jpg"
    ...
    if ( cfg.DATA_MSlide.length > 5 ) {
			...
			<script type="text/javascript">
			 $(function(){
				...
				pageConfig.DATA_MScroll = [
						...
						{
							"alt" : "",
							"href" : "http://www.jt.com/items/536563.html",
							"index" : 1,
		...
		<div id="jdnews" class="m m1">
			...
			<div class="mc">
				<ul align='center'>
					<h3>
						行路难 · 其一 唐 · 李白</br> 欲渡黄河冰塞川，将登太行雪满山.</br> 闲来垂钓碧溪上，忽复乘舟梦日边.</br> 行路难！行路难！多歧路，今安在?</br>
						长风破浪会有时，直挂云帆济沧海.</br>
					</h3>
		...
		<div class="w w1" data-fid="0" id="electronics">
			...
			<div class="fr da209x180" clstag="homepage|keycount|home2013|19b">
				<div class="slide" data-lazyload="8">
					<img
						src="https://img14.360buyimg.com/mobilecms/s280x280_jfs/t1/16458/17/15129/75341/5cac4e58E4d9740d7/cce3e371d83fd7a2.jpg!q90.webp"
						alt="爱国者充电包" width="100%" height="100%" />
				</div>
				<span class="clr"></span>
			</div>
			<!-- 家电通讯楼层 end-->
